...
function makeDirectionHref(direction: 'all' | EarningsGapDirection, demo: boolean): string {
  ...
  return (
    <main className="mx-auto w-full max-w-7xl px-4 py-6">
      ...
      <div className="mb-4 flex flex-wrap items-center gap-2 text-xs">
        ...
        <FilterLink href={makeDirectionHref('all', demo)} active={direction === 'all'}>
          All
        </FilterLink>
        <FilterLink href={makeDirectionHref('up', demo)} active={direction === 'up'}>
          Gap up
        </FilterLink>
        <FilterLink href={makeDirectionHref('down', demo)} active={direction === 'down'}>
          Gap down
        </FilterLink>
        {demo ? (
          <Link
            href={makeDirectionHref(direction, false)}
          ...
          <Link
            href={makeDirectionHref(direction, true)}
            className="ml-2 rounded-full border border-border bg-surface px-3 py-1 font-semibold text-sub hover:bg-surface-hover hover:text-text"
          >
            Demo
          </Link>
