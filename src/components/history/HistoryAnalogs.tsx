...
/** HistoryAnalogs — DTW chart-shape matcher dashboard. Pick a past
 *  date+ticker, see its 5 most-similar past mornings and what happened
 *  after each. Migrated from /analogs into a /history tab so historical
 *  exploration lives in one nav entry.
 *
 *  Loads /analogs/corpus.json + /analogs/matches.json (still served from
 *  the public dir — the JSON paths haven't moved). The shared
...
export function HistoryAnalogs() {
