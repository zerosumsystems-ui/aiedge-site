"""Invariant tests for mtr_detector.
Run: python3 scripts/ml/mtr_detector_test.py
...
def main():
    ...
    print(f"PASS mtr: {total} signals across {len(sessions)} sessions, "
