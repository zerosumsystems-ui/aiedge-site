"""Invariant tests for climax_detector.
Run: python3 scripts/ml/climax_detector_test.py
...
def main():
    ...
    for bars in sessions:
        for sg in detect_climaxes(bars, "5m"):
            total += 1
    ...
    print(f"PASS climax: {total} signals across {len(sessions)} sessions, "
