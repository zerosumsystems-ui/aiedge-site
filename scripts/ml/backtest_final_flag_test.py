"""Tests for the final_flag scaling-in trade engine.

Run: python3 scripts/ml/backtest_final_flag_test.py
"""
...
import backtest_final_flag as bt  # noqa: E402
...
if __name__ == "__main__":
    ...
    print("\nall backtest_final_flag tests passed")
