"""Tests for the double-top scaling-in trade engine.

Run: python3 scripts/ml/backtest_double_top_test.py
"""
...
import backtest_double_top as bt  # noqa: E402
...
if __name__ == "__main__":
    ...
    print("\nall backtest_double_top tests passed")
