"""Invariant tests for final_flag_detector.
Run: python3 scripts/ml/final_flag_detector_test.py
...
def main():
    ...
    for bars in sessions:
        for sg in detect_final_flags(bars, "5m"):
            total += 1
    ...
    print(f"PASS final_flag: {total} signals across {len(sessions)} sessions, "
