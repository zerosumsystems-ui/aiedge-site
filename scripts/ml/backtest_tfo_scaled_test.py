"""Tests for the TFO scaling-in trade engine.

Run: python3 scripts/ml/backtest_tfo_scaled_test.py
"""
...
import backtest_tfo_scaled as bt  # noqa: E402
...
if __name__ == "__main__":
    ...
    print("\nall backtest_tfo_scaled tests passed")
