"""Tests for the wedge scaling-in trade engine.

Run: python3 scripts/ml/backtest_wedge_test.py
"""
...
import backtest_wedge as bt  # noqa: E402
...
if __name__ == "__main__":
    ...
    print("\nall backtest_wedge tests passed")
