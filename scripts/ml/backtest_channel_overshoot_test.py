"""Tests for the channel_overshoot scaling-in trade engine.

Run: python3 scripts/ml/backtest_channel_overshoot_test.py
"""
...
import backtest_channel_overshoot as bt  # noqa: E402
...
if __name__ == "__main__":
    ...
    print("\nall backtest_channel_overshoot tests passed")
