"""Tests for the pullback scaling-in trade engine.

Run: python3 scripts/ml/backtest_pullback_test.py
"""
...
import backtest_pullback as bt  # noqa: E402
...
def _bar(o, h, l, c):
    return Bar(t=0, o=o, h=h, l=l, c=c)
...
if __name__ == "__main__":
    ...
    print("\nall backtest_pullback tests passed")
