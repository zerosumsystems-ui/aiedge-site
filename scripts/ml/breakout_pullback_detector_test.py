"""Invariant tests for breakout_pullback_detector.
Run: python3 scripts/ml/breakout_pullback_detector_test.py
...
def main():
    ...
    for bars in sessions:
        for sg in detect_breakout_pullbacks(bars, "5m"):
            total += 1
    ...
    print(f"PASS breakout_pullback: {total} signals across {len(sessions)} sessions, "
