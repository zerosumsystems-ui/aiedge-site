"""Tests for the breakout_pullback scaling-in trade engine.

Run: python3 scripts/ml/backtest_breakout_pullback_test.py
"""
...
import backtest_breakout_pullback as bt  # noqa: E402
...
if __name__ == "__main__":
    ...
    print("\nall backtest_breakout_pullback tests passed")
