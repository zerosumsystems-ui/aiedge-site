"""Tests for the trading_range scaling-in trade engine.

Run: python3 scripts/ml/backtest_trading_range_test.py
"""
...
import backtest_trading_range as bt  # noqa: E402
...
if __name__ == "__main__":
    ...
    print("\nall backtest_trading_range tests passed")
