"""Tests for the climax scaling-in trade engine.

Run: python3 scripts/ml/backtest_climax_test.py
"""
...
import backtest_climax as bt  # noqa: E402
...
if __name__ == "__main__":
    ...
    print("\nall backtest_climax tests passed")
