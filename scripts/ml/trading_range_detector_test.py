"""Invariant tests for trading_range_detector.
Run: python3 scripts/ml/trading_range_detector_test.py
...
def main():
    ...
    for bars in sessions:
        for sg in detect_trading_range_breakouts(bars, "5m"):
            total += 1
    ...
    print(f"PASS trading_range: {total} signals across {len(sessions)} sessions, "
