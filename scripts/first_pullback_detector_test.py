...
def test_first_pullback_long():
    ...
    # stop = 1 tick below the pullback extreme (low 101.8)
    assert_eq(s.stop_price, 101.79, "stop 1 tick below pullback extreme")
...
def test_first_pullback_short():
    ...
    # stop = 1 tick above the pullback extreme (high 98.0)
    assert_eq(s.stop_price, 98.01, "stop 1 tick above pullback extreme")
